...
//        header('Access-Control-Allow-Headers: X-Requested-With,X_Requested_With'); //设置允许的跨域header
        ...
        $CONFIG = json_decode(preg_replace("/\/\*[\s\S]+?\*\//", "", file_get_contents(ROOT_PATH . "public/static/ueditor/php/config.json")), true);
        //dump(ROOT_PATH);exit;
        $action = $_GET['action'];
	...
	private function upFile($fieldName){
		...
		if($info){//上传成功
			$fname=$url . '/tp5/public/static/uploads/'.str_replace('\\','/',$info->getSaveName());
