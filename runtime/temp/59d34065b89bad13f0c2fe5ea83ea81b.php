<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"C:\wnmp\nginx\html\tp5\public/../application/index\view\index\product.html";i:1523956194;}*/ ?>
<html lang="zh-CN">
...
<div class="container-fluid img-wrap">
    <?php if($pname =='公司简介'): ?><img class="img-brand img-responsive" src="__STATIC__/index/img/product/intr1.jpg"/><?php endif; if($pname =='产品售后'): ?><img class="img-brand img-responsive" src="__STATIC__/index/img/product/intr2.jpg"/><?php endif; ?>
</div>
