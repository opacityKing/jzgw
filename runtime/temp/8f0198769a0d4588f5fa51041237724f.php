						...
						<div class="widget">
							...
							<div class="widget-body">
								<div id="horizontal-form">
									<form class="form-horizontal" role="form" action="<?php echo url('Product/doUpd'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
												<select id="cateid" name="cateid" style="width: 100%;">
													...
													<option value="<?php echo $v['cate_id']; ?>" <?php if($v['cate_id'] == $data['cateid']): ?>selected="selected" <?php endif; ?>><?php echo $v['cate_name']; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										<div class="form-group">
											<label for="introduce" class="col-sm-2 control-label no-padding-right">产品介绍</label>
											<div class="col-sm-8">
												<textarea id="introduce" name="introduce"><?php echo $data['introduce']; ?></textarea>
											</div>
										</div>
										<div class="form-group">
											<label for="comments" class="col-sm-2 control-label no-padding-right">产品备注</label>
											<div class="col-sm-8">
												<textarea class="form-control" id="comments" name="comments" rows="2" maxlength="83"><?php echo $data['comments']; ?></textarea>
											</div>
										</div>
