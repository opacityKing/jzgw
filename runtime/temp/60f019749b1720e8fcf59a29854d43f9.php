<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\wnmp\nginx\html\tp5\public/../application/admin\view\News\add.html";i:1517303522;s:80:"C:\wnmp\nginx\html\tp5\public/../application/admin\view\common\page_sidebar.html";i:1522823630;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<div class="widget">
							...
							<div class="widget-body">
								<div id="horizontal-form">
									<form class="form-horizontal" role="form" action="<?php echo url('News/add'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input class="form-control" id="source" placeholder="" name="source" type="text">
											</div>
											<p class="help-block col-sm-4 red">* 必填</p>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input class="form-control" id="editor" placeholder="" name="editor" type="text">
											</div>
											<p class="help-block col-sm-4 red">* 必填</p>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-6">
												<textarea class="form-control" id="des" name="des" rows="2" maxlength="83"></textarea>
											</div>
											<p class="help-block col-sm-4 red">* 必填</p>
										</div>
										<div class="form-group">
