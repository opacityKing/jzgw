<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\wnmp\nginx\html\tp5\public/../application/admin\view\Device\add.html";i:1513224010;}*/ ?>
<!DOCTYPE html>
<html>
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
						<div class="widget">
							<div class="widget-header bordered-bottom bordered-blue">
								<span class="widget-caption">新增设备</span>
							</div>
							<div class="widget-body">
								<div id="horizontal-form">
									<form class="form-horizontal" role="form" action="<?php echo url('Device/add'); ?>" method="post">
										<div class="form-group">
											<label for="deviceName" class="col-sm-2 control-label no-padding-right">设备名</label>
											<div class="col-sm-6">
												<input class="form-control" id="deviceName" placeholder="" name="deviceName" required="" type="text">
											</div>
