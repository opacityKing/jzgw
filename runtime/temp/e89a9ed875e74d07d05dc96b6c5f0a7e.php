<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"C:\wnmp\nginx\html\tp5\public/../application/admin\view\cate\index.html";i:1515397933;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="flip-scroll">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="<?php echo url("Cate/upd",array('id'=>$v['cate_id'])); ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>

                                        <a href="#" onClick="warning('确实要删除吗', '<?php echo url("Cate/del",array('id'=>$v['cate_id'])); ?>')"
