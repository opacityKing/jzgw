							...
							<div class="widget-body">
								<div id="horizontal-form">
									<form class="form-horizontal" role="form" action="<?php echo url('Article/add'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											<label for="title" class="col-sm-2 control-label no-padding-right">缩略图</label>
											<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input class="form-control" id="html_id" placeholder="" name="html_id" type="text">
											</div>
