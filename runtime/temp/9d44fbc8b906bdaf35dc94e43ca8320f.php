<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"C:\wnmp\nginx\html\tp5\public/../application/index\view\project\project.html";i:1521010994;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
	...
	<head>
		...
		<link href="__STATIC__/index/css/map_test_point.css" rel="stylesheet">
				...
				<div class="col-md-2 col-xs-1 left-sidebar nav">
					<ul class="list-group">
						<li class="list-group-item hand js-sidenav" id="infor">
							<span class="glyphicon glyphicon-wrench" aria-hidden="true"></span> 项目详情
						</li>
						<li class="list-group-item hand js-sidenav" id="position">
							<span class="glyphicon glyphicon-globe" aria-hidden="true"></span> 设备分布
						</li>
						<li class="list-group-item hand js-sidenav" id="overview">
							<span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> 设备总览
						</li>
						<li class="list-group-item hand js-sidenav" id="alarm">
							<span class="glyphicon glyphicon-option-vertical" aria-hidden="true"></span> 报警情况
						</li>

						<li class="list-group-item hand js-sidenav" id="include">
							<span class="glyphicon glyphicon-list" aria-hidden="true"></span> 包含产品
						</li>
	...
	<script>
		$(function() {
			...
			$(".left-sidebar .js-sidenav").click(function() {
				...
				$.post("<?php echo url('Project/rightArea'); ?>", {
						type: sidebarid
					},
					function(data) {
