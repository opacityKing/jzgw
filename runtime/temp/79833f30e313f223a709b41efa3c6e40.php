<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"C:\wnmp\nginx\html\tp5\public/../application/admin\view\admin\add.html";i:1516946315;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
				...
				<div class="col-sm-12 form-wrap">
					<form class="form-horizontal" action="order/order" method="post">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="username" class="form-control" id="" placeholder="简要说明问题，比如路灯故障等">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<div class="col-sm-12" style="text-align: center;">
								<button type="submit" class=" btn btn-warning">完成添加</button>
							</div>
						</div>
					</form>
				</div>
