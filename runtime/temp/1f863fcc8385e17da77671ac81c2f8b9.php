<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"C:\wnmp\nginx\html\tp5\public/../application/index\view\index\pthird.html";i:1523953423;}*/ ?>
<html lang="zh-CN">
...
<div class="container main main-product">
    <div class="row main-part1">
        <div class="col-sm-12 part1-title">
            <ol class="breadcrumb">
                <li><a href="javascript:history.back(-1)"><?php echo $breadname1; ?></a></li>
                <li class=""><strong><?php echo $breadname2; ?></strong></li>
            </ol>
        </div>
        ...
        <div class="col-sm-3 col-xs-6" style="margin-bottom: 15px">
            <div class="part1-left">
                ...
                <a href="<?php echo url('Index/pdetails',['cid'=>$v['cate_id'],'pid'=>$v['parent_id']]); ?>">
