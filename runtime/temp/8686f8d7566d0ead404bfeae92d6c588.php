<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"C:\wnmp\nginx\html\tp5\public/../application/admin\view\article\upd.html";i:1517303601;s:80:"C:\wnmp\nginx\html\tp5\public/../application/admin\view\common\page_sidebar.html";i:1523329843;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="page-content">
			...
			<div class="page-breadcrumbs">
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo url('Article/index'); ?>">文章列表</a>
					</li>
					<li class="active">修改导航文章</li>
				</ul>
			</div>
			<!-- /Page Breadcrumb -->
						...
						<div class="widget">
							...
							<div class="widget-body">
								<div id="horizontal-form">
									<form class="form-horizontal" role="form" action="<?php echo url('Article/doUpd'); ?>" method="post" enctype="multipart/form-data">

										<div class="form-group">
											<label for="title" class="col-sm-2 control-label no-padding-right">文章标题</label>
											<div class="col-sm-6">
												<input class="form-control" id="title" placeholder="" name="title" value="<?php echo $articleData['title']; ?>" required="" type="text">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<select id="cateid" name="cateid" style="width: 100%;">
													...
													<option value="<?php echo $v['cate_id']; ?>" <?php if($v['cate_id'] == $articleData['cateid']): ?>selected="selected" <?php endif; ?>><?php echo $v['cate_name']; ?></option>
													<?php endforeach; ?>
												</select>
											</div>
											<p class="help-block col-sm-4 red">* 必填</p>
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="file" id="pic" name="pic" value="<?php echo $articleData['pic']; ?>"></input>
												<?php if($articleData['pic'] != ''): ?>
												<img src="<?php echo $articleData['pic']; ?>" width="80"> <?php else: ?> 暂无缩略图 <?php endif; ?>
											</div>
										</div>

										<div class="form-group">
											<label for="html_id" class="col-sm-2 control-label no-padding-right">网页ID</label>
											<div class="col-sm-6">
												<input class="form-control" id="html_id" placeholder="" name="html_id" type="text" value="<?php echo $articleData['html_id']; ?>">
											</div>
											<p class="help-block col-sm-4 red">* 推荐由小写字母组成的有意义单词</p>
										</div>

										<div class="form-group">
											<label for="content" class="col-sm-2 control-label no-padding-right">文章详情</label>
											<div class="col-sm-6">
												<textarea id="content" name="content"><?php echo $articleData['content']; ?></textarea>
											</div>
											<p class="help-block col-sm-4 red">* 必填</p>
										</div>
