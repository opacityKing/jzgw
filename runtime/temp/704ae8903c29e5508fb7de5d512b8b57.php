<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"C:\wnmp\nginx\html\tp5\public/../application/index\view\group\index.html";i:1515977428;}*/ ?>
<html lang="zh-CN">
	...
	<body>
		...
		<div class="container project-wrap">
			<div class="row project-title">
				<h4>您拥有的分组如下：
				<a class="btn btn-primary pull-right" target="_blank" href="<?php echo url('group/fetchAddGroup'); ?>">添加分组</a></h4>
			</div>
			<div class="row">
					...
					<div class="panel panel-info">
						...
						<ul class="list-group">
							<li class="list-group-item" style="height: 3rem; text-align: center;">
								<a class="col-md-6" target="_blank" href="<?php echo url('group/group'); ?>" style="border-right: solid 1px #ddd;">查看详情</a>
								<a class="col-md-6" class="delgroup" id="0001" href="">删除分组</a>
							</li>
	...
	<script>
		$(".delgroup").click(function() {
			...
			if(r == true) {
				...
				$.post("<?php echo url('group/delGroup'); ?>", {
						groupid: groupid
					},
					function() {
						alert("删除成功");
